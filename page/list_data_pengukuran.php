            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li><a class="nav-link active" data-target="list-data-pengukuran-section" href="list_data_pengukuran.php"><i class="fas fa-list-alt"></i> <span>List Data Pengukuran</span></a></li>

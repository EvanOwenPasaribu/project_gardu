...
function add_location(){
    ...
    $alamat = $_GET['alamat'];
    $daya =$_GET['daya'];
    $penyulang =$_GET['penyulang'];

    // Inserts new row with place data.
    $query = sprintf("INSERT INTO locations " .
        " (id, lat, lng, kode, alamat, daya, penyulang) " .
        ...
        mysqli_real_escape_string($con,$penyulang));
...
select id ,lat,lng,kode,alamat,daya,penyulang,location_status as isconfirmed

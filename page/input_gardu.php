      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li><a class="nav-link active" data-target="input-gardu-section" href="input_gardu.php"><i class="fas fa-plus"></i> <span>Input Gardu</span></a></li>
      ...
      <div class="main-content">  
        <section class="section mt-4 input-gardu-section">
          <div class="map-input">
            ...
            <?php include_once 'map-input.php';?>
          </div>
        </section>
